...
import type { ListRewardsRequest }                      from '@rewards-system/rewards-system-rpc/interfaces'
import type { ListRewardsResponse }                     from '@rewards-system/rewards-system-rpc/interfaces'
import type { ListRewardOperationsRequest }             from '@rewards-system/rewards-system-rpc/interfaces'
import type { ListRewardOperationsResponse }            from '@rewards-system/rewards-system-rpc/interfaces'
import type { CreateRewardOperationRequest }            from '@rewards-system/rewards-system-rpc/interfaces'
import type { CreateRewardOperationResponse }           from '@rewards-system/rewards-system-rpc/interfaces'
import type { ConfirmRewardOperationRequest }           from '@rewards-system/rewards-system-rpc/interfaces'
import type { ConfirmRewardOperationResponse }          from '@rewards-system/rewards-system-rpc/interfaces'
import type { CreateAndConfirmRewardOperationRequest }  from '@rewards-system/rewards-system-rpc/interfaces'
import type { CreateAndConfirmRewardOperationResponse } from '@rewards-system/rewards-system-rpc/interfaces'
...
import { RewardOperationsService }                      from '@rewards-system/rewards-system-rpc/connect'
...
@Controller()
@BufService(RewardOperationsService)
