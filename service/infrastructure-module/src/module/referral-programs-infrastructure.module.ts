...
import { ReferralPointsJournalEntryRepositoryImpl } from '../repositories/index.js'
import { ReferralPointsBalanceRepositoryImpl }      from '../repositories/index.js'
...
export class ReferralProgramsInfrastructureModule implements OnModuleInit {
  ...
  static register(): DynamicModule {
    const repositories = [
      ...
      {
        provide: ReferralPointsBalanceRepository,
        useClass: ReferralPointsBalanceRepositoryImpl,
      },
      {
        provide: ReferralPointsJournalEntryRepository,
        useClass: ReferralPointsJournalEntryRepositoryImpl,
      },
    ]
